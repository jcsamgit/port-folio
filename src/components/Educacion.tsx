  ...
  return (
        <div className='concepto educacion' >
            ...
            <h4 className='maquina'>
                Desarrollador Frontend React (septiembre 2021):<a href='https://www.coderhouse.com/certificados/6179c8375e3d990020befc88'>ver mas</a>
            </h4>
            <ul>
                ...
                <li className='maquina'>Desarrollo Web (febrero-mayo)
